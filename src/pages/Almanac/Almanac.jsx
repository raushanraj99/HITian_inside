    ...
    <div className="bg-[#650808]">
      ...
      <div className="ps-[10%] md:ps-[8%] pt-[5%]">
        <div className="w-[80vw] md:w-[43vw]">
          ...
          <h1 className="text-[3rem] md:text-[5rem] text-[#fdd0d0] font-bold " data-aos="fade-up">Almanac</h1>
          <p className="text-[#f2b5b5] font-medium text-[1.2rem]" data-aos="fade-up">
          ...
          <button type="submit" className="mt-5 text-[#650808] font-bold bg-[#fdd0d0] text-[.9rem] md:text-[1.3rem] w-[120px] h-[38px] md:w-[160px] md:h-[45px] rounded-[50px]
           hover:scale-125 transition-all duration-700" data-aos="fade-up">Submit Here</button>
          </Link>
